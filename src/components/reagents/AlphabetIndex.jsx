...
import { availableLetterSet, allLetters } from '../../lib/reagentLetters'
...
function AlphabetIndex({ data, scrollToLetter, top = 96 }) {
  ...
  const availableLetters = availableLetterSet(data)
  ...
  const letters = allLetters(availableLetters)
  return (
    <div style={{
      width: '22px', flexShrink: 0, marginLeft: '4px',
      position: 'sticky', top: `${top}px`,
