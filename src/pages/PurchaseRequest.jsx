                ...
                {reagentItems.map((it, idx) => {
                  return (
                    <tr key={it.id}>
                      ...
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.cas_no} onChange={e => updateReagentItem(it.id, 'cas_no', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}>
                        <input className="wide-on-focus" value={it.state} onChange={e => updateReagentItem(it.id, 'state', e.target.value)} placeholder="액체/고체 등"
                          list="reagent-state-options"
                          style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} />
                      </td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.needed_amount} onChange={e => updateReagentItem(it.id, 'needed_amount', e.target.value)} placeholder="500mL 이상" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.usage_place} onChange={e => updateReagentItem(it.id, 'usage_place', e.target.value)} placeholder="예) 유기합성 실험" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '110px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.purchase_reason} onChange={e => updateReagentItem(it.id, 'purchase_reason', e.target.value)} placeholder="예) 재고 소진" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '100px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.company} onChange={e => updateReagentItem(it.id, 'company', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.cat_no} onChange={e => updateReagentItem(it.id, 'cat_no', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.spec} onChange={e => updateReagentItem(it.id, 'spec', e.target.value)} placeholder="500 mL" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.quantity} onChange={e => updateReagentItem(it.id, 'quantity', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '50px' }} /></td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.unit_price} onChange={e => updateReagentItem(it.id, 'unit_price', e.target.value)} placeholder="원" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} /></td>
                      <td style={{ ...tdStyle, fontWeight: '700', color: C.navy, whiteSpace: 'nowrap' }}>{totalOf(it).toLocaleString()}원</td>
                      <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.note} onChange={e => updateReagentItem(it.id, 'note', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '100px' }} /></td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '1000px' }}>
              ...
              <tbody>
                {goodsItems.map((it, idx) => (
                  <tr key={it.id}>
                    <td style={{ ...tdStyle, textAlign: 'center', color: C.muted }}>{idx + 1}</td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.name} onChange={e => updateGoodsItem(it.id, 'name', e.target.value)} placeholder="제품명 입력" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '160px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.cat_no} onChange={e => updateGoodsItem(it.id, 'cat_no', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.spec} onChange={e => updateGoodsItem(it.id, 'spec', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.quantity} onChange={e => updateGoodsItem(it.id, 'quantity', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '50px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.unit_price} onChange={e => updateGoodsItem(it.id, 'unit_price', e.target.value)} placeholder="원" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.shipping_fee} onChange={e => updateGoodsItem(it.id, 'shipping_fee', e.target.value)} placeholder="원" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '80px' }} /></td>
                    <td style={{ ...tdStyle, fontWeight: '700', color: C.navy }}>{totalOf(it).toLocaleString()}원</td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.purpose} onChange={e => updateGoodsItem(it.id, 'purpose', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '100px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.note} onChange={e => updateGoodsItem(it.id, 'note', e.target.value)} style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', width: '90px' }} /></td>
                    <td style={{ ...tdStyle, position: 'relative' }}><input className="wide-on-focus" value={it.link} onChange={e => updateGoodsItem(it.id, 'link', e.target.value)} placeholder="구매 링크" style={{ ...inputStyle, padding: '5px 8px', fontSize: '12.5px', minWidth: '110px' }} /></td>
                    <td className="no-print" style={{ ...tdStyle, textAlign: 'center', whiteSpace: 'nowrap' }}>
